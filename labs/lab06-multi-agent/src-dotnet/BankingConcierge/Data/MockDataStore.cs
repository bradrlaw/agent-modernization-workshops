...
using BankingConcierge.Models;

namespace BankingConcierge.Data;
...
public static class MockDataStore
{
    ...
    private static IReadOnlyList<T> LoadJson<T>(string fileName)
    {
    ...
    private static string ResolveDataDirectory()
    {
        ...
        throw new DirectoryNotFoundException("Unable to locate the data directory for the banking concierge.");
    }
